...
Securely install the latest [wheel](https://pypi.org/project/wheel/) release from PyPI.

This action installs a pinned version of **wheel** and all its dependencies,         making sure that file hashes match. Pinning your dependencies:
...
```yaml
      - name: Install wheel from PyPI
        uses: install-pinned/wheel@2e6ea0da13ace71bb2bd4074e4fefaaf0fc849d8  # 0.44.0
```
